% Order 1 explicit Euler method

function [T, Y] = method_euler(f, t, ci)
    % This function performs the explicit Euler method to solve ODEs.
    % Inputs:
    ...
    for i = 1:n-1
        ...
        y(:, i+1) = y(:, i) + h*k1; % Update the solution using the Euler method
    end
